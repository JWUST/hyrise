...
INSTANTIATE_TEST_CASE_P(RadixJoinApplyDynamicParallelizationTest, RadixApplyDynParallelizationTest, ::testing::Values(taskscheduler::DynamicCount{1,1,1,1}, taskscheduler::DynamicCount{4,4,4,4}));
